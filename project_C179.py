...
import random
root = Tk()
root.title("Encapsulación")
root.geometry("500x400")
root.config(bg="white")
label_score = Label(root, text="Puntos: 0",font=("Bahnschrift Light",15,"bold") ,bg="white")
...
btn = Button(root, text="VERIFICAR" ,command=getInput, bg="IndianRed1", fg="white", relief=FLAT,  padx=10, pady=1,  font=("Arial",15))
btn.place(relx=0.35,rely=0.65, anchor= CENTER)
btn = Button(root, text="INICIAR" ,command=obj.updateGame, bg="dark olive green", fg="white", relief=FLAT,  padx=10, pady=1,  font=("Arial",15))
